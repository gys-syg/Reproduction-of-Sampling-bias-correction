...
def compute_loss(q_emb, i_emb, pos_rows, freq_estimator, global_step, temperature=0.05, hard_neg_m=20):
    ...
    for epoch in range(args.epochs):
        ...
        for batch in train_loader:
            ...
            loss, metrics = compute_loss(q_emb, i_emb, pos_row, freq_estimator=freq_est,
                                         ...
                                         hard_neg_m=args.hard_negatives)
...
if __name__ == "__main__":
    ...
    p.add_argument("--save_path", type=str, default="/mnt/data/sbcnm_real_ckpt.pt")
